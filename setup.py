...
setup(
    ...
    description="This is a simple deep learning framework for many deep learning algorithms built from scratch with just numpy, it is meant for educational purposes only",  # noqa
    entry_points={
        "console_scripts": [
